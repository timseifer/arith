...
all: ppmdiff 40image testingbit 40image-6
...
ppmdiff: ppmdiff.o main.o a2plain.o uarray2.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)
40image: compress40.o a2plain.o uarray2.o 40image.o componentVCS.o componentDCT.o componentPacking.o bitpack.o 
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)
40image-6: compress40.o a2plain.o uarray2.o 40image.o componentVCS.o componentDCT.o componentPacking.o bitpack.o 
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)
testingbit: test.o bitpack.o
	$(CC) $(LDFLAGS) $^ -o $@ $(LDLIBS)
clean:
	rm -f ppmdiff *.o
